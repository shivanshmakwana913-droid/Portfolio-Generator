...
const PROMPT_SUGGESTIONS = {
    ...
    bio: [
        "Passionate developer who loves turning ideas into real-world applications. I enjoy clean code, creative problem-solving, and building things that make people's lives easier.",
        "A self-taught programmer with a love for building modern web applications. I focus on writing scalable, maintainable code and constantly push myself to learn new technologies.",
        "Creative designer and developer blending aesthetics with functionality. I believe great software should not only work perfectly but also look beautiful and feel intuitive.",
        "Results-driven engineer with a strong foundation in computer science. I thrive in collaborative environments and love tackling complex challenges with elegant solutions.",
        "Tech enthusiast and lifelong learner. From crafting pixel-perfect UIs to designing robust backend systems, I enjoy every part of the development journey.",
    ],
    skills: [
        'React, JavaScript, HTML, CSS, Node.js',
        'Python, Django, PostgreSQL, Docker, AWS',
        'React Native, Flutter, Firebase, TypeScript',
        'Figma, Adobe XD, Photoshop, Illustrator',
        'Java, Spring Boot, MySQL, Kubernetes, Git',
        'Next.js, Tailwind CSS, MongoDB, GraphQL',
    ],
    projectTitle: [
        'E-Commerce Platform',
    ...
    projectDesc: [
        'A full-featured online store with product listings, shopping cart, payment integration, and order tracking. Built with modern web technologies for a smooth shopping experience.',
        'An interactive dashboard that aggregates social media analytics, showing engagement metrics, follower growth, and content performance in beautiful charts.',
        'A responsive weather application that provides real-time forecasts, hourly predictions, and 7-day outlooks using geolocation and a weather API.',
        'A collaborative task management tool with drag-and-drop boards, team assignments, deadline tracking, and real-time notifications.',
        'A personal portfolio showcasing projects, skills, and experience with multiple theme options and a clean, modern design.',
    ],
};
